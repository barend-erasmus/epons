CREATE PROCEDURE [EPONS_API].[ListReferringDoctorsByPatientId] 
...
ON [doctor].[Id] = [episodeOfCare].[ReferringDoctorId]
...
EXEC [Audit].[CreateLogEntry] '[EPONS_API].[ListReferringDoctorsByPatientId]', 'Executed'