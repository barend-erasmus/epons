...
namespace Epons.Domain.Repositories
{
    public class PatientRepository
    {
        ...
        {
            using (Metrics.StartTimer($"PatientRepository-FindById"))
            {
        ...
        {
            using (Metrics.StartTimer($"PatientRepository-FindByIdentificationNumber"))
            {
        ...
        {
            using (Metrics.StartTimer($"PatientRepository-FindByDetails"))
            {
        ...
        {
            using (Metrics.StartTimer($"PatientRepository-ListActiveAsUser"))
            {
        ...
        {
            using (Metrics.StartTimer($"PatientRepository-ListActiveAsFacility"))
            {
                var result = _context.Details2
        ...
        {
            using (Metrics.StartTimer($"PatientRepository-CalculateTimeSpent"))
            {
